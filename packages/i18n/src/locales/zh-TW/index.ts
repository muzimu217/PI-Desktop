...
sklm: {
  ...
  index: {
    ...
    "grepBoostDesc": "開啟後自動為新開啟的工作區建立索引，並加速符合條件的字面量查詢；其他查詢自動回退 rg。所有資料均保存在本機。",
    ...
    emptyDesc: "建立索引後可查看檔案數與大小。索引僅保存在本機。",
    actions: "索引操作",
  ...
  stats: {
    ...
    loading: "正在讀取本機會話歷史…",
    loadError: "使用統計暫不可用",
    loadErrorHost: "無法連線本機服務。你的歷史記錄仍然安全，請重試。",
    range: "範圍",
    range7: "近 7 日",
    range30: "近 30 日",
    refresh: "重新整理",
    ...
    inclSubagents: "含子代理消耗",
    peakDay: "高峰日 Token",
    longestChat: "最長對話",
    pureChat: "純對話時長",
    currentStreak: "目前連續",
    longestStreak_one: "最長 1 天",
    longestStreak_other: "最長 {{count}} 天",
    days_one: "1 天",
    days_other: "{{count}} 天",
    activity: "活動",
    heatmapAria: "近 {{days}} 天 Token 活動：共 {{tokens}}，峰值 {{peakTokens}}（{{peakDate}}）",
    heatmapTableCaption: "近 365 天每日 Token 活動",
    trendAria: "近 {{days}} 天每日 Token 趨勢：共 {{tokens}}，峰值 {{peakTokens}}（{{peakDate}}）",
    trendTableCaption: "每日 Token 總量及各模型明細",
    tableDate: "日期",
    tableTokens: "Token",
    modelUsage: "模型用量",
    insights: "診斷",
    cacheLeverage: "快取槓桿率",
    largeContext: "大上下文輪次",
    top5Share: "Top 5 會話集中度",
    topSessions: "高消耗會話",
    turns: "{{count}} 輪",
    tooltipTurns_one: "1 輪",
    tooltipTurns_other: "{{count}} 輪",
    dayDelta: "當日",
    granularityDaily: "每日",
    granularityWeekly: "每週",
    granularityCumulative: "累計",
    lastActive: "最近活躍 {{time}}",
    openSession: "開啟會話 {{title}}",
    empty: "該範圍內還沒有會話",
    provenance: "統計由本機會話歷史計算，不會離開這台機器。",
    projectUsage: "專案細分",
    projectUsageOther: "其他",
    noProject: "無專案",
    modelUsageOther: "其他模型",
    emptyTitle: "尚無可用統計",
    emptyDesc: "該範圍內還沒有已完成的對話，統計會隨使用逐步累積。",
    emptyAction: "返回主介面",
    nudgeText: "這兩項功能都在本機執行，不會上傳工作區內容。",
    nudgeDismiss: "知道了",
    lastUpdated: "最後更新於 {{time}}",
    provenanceFields: "包含 Token、對話時長、模型、專案。",
    loadingPrivacy: "資料不會上傳伺服器。",
    "projectFilter": "專案",
    "allProjects": "全部專案",
  },
