...
importConfirm: "Imported extensions run inside the agent process with the same access as the agent's own tools. Declared skills can add instructions to the agent, and declared dependencies are installed with npm (install scripts disabled). Continue?",
  ...
  stats: {
    ...
    loadErrorHost: "Can't reach the local service. Your history is safe — try again.",
    range: "Range",
    range7: "Last 7 days",
    ...
    inclSubagents: "Includes subagent spend",
    peakDay: "Peak day",
    longestChat: "Longest chat",
    pureChat: "Pure chat time",
    currentStreak: "Current streak",
    longestStreak_one: "Longest: 1 day",
    longestStreak_other: "Longest: {{count}} days",
    days_one: "1 day",
    days_other: "{{count}} days",
    activity: "Activity",
    heatmapAria: "Token activity over the last {{days}} days: {{tokens}} tokens total, peak {{peakTokens}} on {{peakDate}}",
    heatmapTableCaption: "Daily token activity for the last 365 days",
    trendAria: "Daily token trend for {{days}} days: {{tokens}} tokens total, peak {{peakTokens}} on {{peakDate}}",
    trendTableCaption: "Daily token totals and per-model breakdown",
    tableDate: "Date",
    tableTokens: "Tokens",
    modelUsage: "Model usage",
    insights: "Insights",
    cacheLeverage: "Cache leverage",
    largeContext: "Large-context turns",
    top5Share: "Top 5 session share",
    ...
    projectUsage: "Project breakdown",
    projectUsageOther: "Other",
    noProject: "No project",
    modelUsageOther: "Other models",
    emptyTitle: "No usage data yet",
    emptyDesc: "No completed conversations in this range yet. Statistics appear as you chat.",
    emptyAction: "Back to app",
    nudgeText: "Both features run locally and never upload your workspace content.",
    nudgeDismiss: "Dismiss",
    lastUpdated: "Last updated {{time}}",
    provenanceFields: "Covers tokens, chat duration, models, and projects.",
    loadingPrivacy: "Data is never uploaded to a server.",
