...
sklm: {
    ...
    "groupData": "Données et statistiques",
    "groupSystem": "Système",
...
"importConfirm": "Les extensions importées s’exécutent dans le processus de l’agent avec les mêmes droits que ses outils. Les compétences déclarées peuvent ajouter des instructions à l’agent et les dépendances déclarées sont installées avec npm (scripts d’installation désactivés). Continuer ?",
  ...
  "index": {
    ...
    "emptyDesc": "Créez-en un pour voir le nombre et la taille des fichiers. L'index reste sur cette machine.",
  ...
  "stats": {
    ...
    "provenanceShort": "Historique local · rien ne quitte cette machine",
    "badgeHighest": "Record",
    "badgeRecord": "Meilleur",
    "badgeOnTrack": "En cours",
    "heatWeekdays": "Lun,Mar,Mer,Jeu,Ven,Sam,Dim",
    "heatLow": "Faible",
    "heatHigh": "Élevé",
    "loading": "Lecture de l'historique local des sessions…",
    "loadError": "Statistiques indisponibles",
    "loadErrorHost": "Le service local est injoignable. Votre historique reste intact — réessayez.",
    "range": "Période",
    ...
    "inclSubagents": "Sous-agents inclus",
    "peakDay": "Jour de pointe",
    "longestChat": "Chat le plus long",
    "pureChat": "Temps de chat pur",
    "currentStreak": "Série actuelle",
    "longestStreak_one": "Record : 1 jour",
    "longestStreak_other": "Record : {{count}} jours",
    "days_one": "1 jour",
    "days_other": "{{count}} jours",
    "activity": "Activité",
    "heatmapAria": "Activité des tokens sur les {{days}} derniers jours : {{tokens}} au total, pic de {{peakTokens}} le {{peakDate}}",
    "heatmapTableCaption": "Activité quotidienne des tokens sur les 365 derniers jours",
    "trendAria": "Tendance quotidienne des tokens sur {{days}} jours : {{tokens}} au total, pic de {{peakTokens}} le {{peakDate}}",
    "trendTableCaption": "Totaux quotidiens de tokens et détail par modèle",
    "tableDate": "Date",
    "tableTokens": "Tokens",
    "modelUsage": "Usage par modèle",
    "insights": "Diagnostic",
    "cacheLeverage": "Levier de cache",
    "largeContext": "Tours à grand contexte",
    "top5Share": "Concentration top 5",
    "topSessions": "Sessions principales",
    "turns": "{{count}} tours",
    ...
    "openSession": "Ouvrir la session {{title}}",
    "empty": "Aucune session sur cette période",
    "provenance": "Calculé localement à partir de votre historique. Rien ne quitte cette machine.",
    "projectUsage": "Répartition par projet",
    "projectUsageOther": "Autres",
    "noProject": "Aucun projet",
    "modelUsageOther": "Autres modèles",
    "emptyTitle": "Aucune statistique disponible",
    "emptyDesc": "Aucune conversation terminée sur cette période. Les statistiques s'étoffent à mesure de l'utilisation.",
    "emptyAction": "Retour à l'app",
    ...
    "provenanceFields": "Inclut les tokens, la durée des conversations, les modèles et les projets.",
    "loadingPrivacy": "Les données ne sont jamais envoyées à un serveur.",
    "projectFilter": "Projet",
