...
"importConfirm": "Importierte Erweiterungen laufen im Agentenprozess mit denselben Rechten wie die Tools des Agenten. Deklarierte Skills können dem Agenten Anweisungen hinzufügen, und deklarierte Abhängigkeiten werden mit npm installiert (Installationsskripte deaktiviert). Fortfahren?",
  ...
  "stats": {
    ...
    "provenanceShort": "Lokaler Sitzungsverlauf · nichts verlässt diesen Rechner",
    "badgeHighest": "Höchster",
    "badgeRecord": "Rekord",
    "badgeOnTrack": "Auf Kurs",
    "heatWeekdays": "Mo,Di,Mi,Do,Fr,Sa,So",
    "heatLow": "Wenig",
    "heatHigh": "Viel",
    "loading": "Lokaler Sitzungsverlauf wird gelesen…",
    "loadError": "Nutzungsstatistik nicht verfügbar",
    "loadErrorHost": "Der lokale Dienst ist nicht erreichbar. Ihr Verlauf bleibt sicher — bitte erneut versuchen.",
    "range": "Zeitraum",
    ...
    "inclSubagents": "Inkl. Subagenten",
    "peakDay": "Spitzentag",
    "longestChat": "Längster Chat",
    "pureChat": "Reine Chatzeit",
    "currentStreak": "Aktuelle Serie",
    "longestStreak_one": "Längste: 1 Tag",
    "longestStreak_other": "Längste: {{count}} Tage",
    "days_one": "1 Tag",
    "days_other": "{{count}} Tage",
    "activity": "Aktivität",
    "heatmapAria": "Token-Aktivität der letzten {{days}} Tage: insgesamt {{tokens}}, Spitze {{peakTokens}} am {{peakDate}}",
    "heatmapTableCaption": "Tägliche Token-Aktivität der letzten 365 Tage",
    "trendAria": "Täglicher Token-Verlauf über {{days}} Tage: insgesamt {{tokens}}, Spitze {{peakTokens}} am {{peakDate}}",
    "trendTableCaption": "Tägliche Token-Summen und Aufschlüsselung je Modell",
    "tableDate": "Datum",
    "tableTokens": "Tokens",
    "modelUsage": "Modellnutzung",
    "insights": "Diagnose",
    "cacheLeverage": "Cache-Hebel",
    "largeContext": "Große Kontexte",
    "top5Share": "Top-5-Sitzungsanteil",
    "topSessions": "Top-Sitzungen",
    "turns": "{{count}} Züge",
    "tooltipTurns_one": "1 Zug",
    "tooltipTurns_other": "{{count}} Züge",
    "dayDelta": "An dem Tag",
    "granularityDaily": "Täglich",
    "granularityWeekly": "Wöchentlich",
    "granularityCumulative": "Kumuliert",
    "lastActive": "zuletzt aktiv {{time}}",
    "openSession": "Sitzung {{title}} öffnen",
    "empty": "Noch keine Sitzungen in diesem Zeitraum",
    "provenance": "Wird lokal aus Ihrem Sitzungsverlauf berechnet. Nichts verlässt diesen Rechner.",
    "projectUsage": "Projekt-Aufschlüsselung",
    "projectUsageOther": "Andere",
    "noProject": "Kein Projekt",
    "modelUsageOther": "Andere Modelle",
    "emptyTitle": "Noch keine Nutzungsdaten",
    "emptyDesc": "Noch keine abgeschlossenen Unterhaltungen in diesem Zeitraum. Die Statistik wächst mit der Nutzung.",
    "emptyAction": "Zurück zur App",
    ...
    "provenanceFields": "Umfasst Tokens, Chatzeit, Modelle und Projekte.",
    "loadingPrivacy": "Daten werden nie auf einen Server hochgeladen.",
