...
sklm: {
  ...
  index: {
    ...
    "grepBoostDesc": "开启后自动为新打开的工作区建立索引，并加速符合条件的字面量查询；其他查询自动回退 rg。所有数据均保存在本机。",
  ...
  stats: {
    ...
    loading: "正在读取本地会话历史…",
    loadError: "使用统计暂不可用",
    loadErrorHost: "无法连接本地服务。你的历史记录仍然安全，请重试。",
    range: "范围",
    range7: "近 7 日",
    range30: "近 30 日",
    refresh: "刷新",
    ...
    pureChat: "纯对话时长",
    currentStreak: "当前连续",
    longestStreak_one: "最长 1 天",
    longestStreak_other: "最长 {{count}} 天",
    days_one: "1 天",
    days_other: "{{count}} 天",
    activity: "活动",
    heatmapAria: "近 {{days}} 天 Token 活动：共 {{tokens}}，峰值 {{peakTokens}}（{{peakDate}}）",
    heatmapTableCaption: "近 365 天每日 Token 活动",
    trendAria: "近 {{days}} 天每日 Token 趋势：共 {{tokens}}，峰值 {{peakTokens}}（{{peakDate}}）",
    trendTableCaption: "每日 Token 总量及各模型明细",
    tableDate: "日期",
    tableTokens: "Token",
    modelUsage: "模型用量",
    insights: "诊断",
    ...
    emptyTitle: "尚无可用统计",
    emptyDesc: "该范围内还没有已完成的对话，统计会随使用逐步积累。",
    emptyAction: "返回主界面",
    nudgeText: "这两项功能都在本地运行，不会上传工作区内容。",
    nudgeDismiss: "知道了",
    lastUpdated: "最后更新于 {{time}}",
    provenanceFields: "包含 Token、对话时长、模型、项目。",
    loadingPrivacy: "数据不会上传服务器。",
    "projectFilter": "项目",
    "allProjects": "全部项目",
  },
