...
importConfirm: "가져온 확장은 에이전트 프로세스 안에서 에이전트 자체 도구와 같은 권한으로 실행됩니다. 선언된 스킬은 에이전트에 지침을 추가할 수 있고, 선언된 의존성은 npm으로 설치됩니다(설치 스크립트 비활성화). 계속할까요?",
  ...
  index: {
    ...
    "grepBoostDesc": "새로 연 워크스페이스를 백그라운드에서 자동으로 색인하고, 조건에 맞는 리터럴 검색은 그 인덱스를 사용합니다. 나머지는 rg로 자동 폴백합니다. 모든 데이터는 이 컴퓨터에 저장됩니다.",
    ...
    emptyDesc: "생성하면 파일 수와 크기를 볼 수 있습니다. 인덱스는 이 컴퓨터에만 저장됩니다.",
    actions: "인덱스 작업",
  ...
  stats: {
    ...
    loadErrorHost: "로컬 서비스에 연결할 수 없습니다. 기록은 안전하니 다시 시도하세요.",
    range: "범위",
    range7: "최근 7일",
    range30: "최근 30일",
    refresh: "새로 고침",
    ...
    totalTokens: "총 토큰",
    inclSubagents: "서브에이전트 포함",
    peakDay: "최고 일",
    longestChat: "가장 긴 대화",
    pureChat: "순수 대화 시간",
    currentStreak: "현재 연속",
    longestStreak_one: "최장 1일",
    longestStreak_other: "최장 {{count}}일",
    days_one: "1일",
    days_other: "{{count}}일",
    activity: "활동",
    heatmapAria: "최근 {{days}}일 토큰 활동: 총 {{tokens}}, 최고 {{peakTokens}} ({{peakDate}})",
    heatmapTableCaption: "최근 365일 일별 토큰 활동",
    trendAria: "{{days}}일간 일별 토큰 추이: 총 {{tokens}}, 최고 {{peakTokens}} ({{peakDate}})",
    trendTableCaption: "일별 토큰 합계 및 모델별 내역",
    tableDate: "날짜",
    tableTokens: "토큰",
    modelUsage: "모델 사용량",
    insights: "진단",
    cacheLeverage: "캐시 활용률",
    largeContext: "대형 컨텍스트 턴",
    top5Share: "Top 5 집중도",
    topSessions: "주요 세션",
    turns: "{{count}}턴",
    tooltipTurns_one: "1턴",
    ...
    openSession: "{{title}} 세션 열기",
    empty: "이 범위에 세션이 없습니다",
    provenance: "로컬 세션 기록으로 계산되며 이 컴퓨터 밖으로 나가지 않습니다.",
    projectUsage: "프로젝트별 사용량",
    projectUsageOther: "기타",
    noProject: "프로젝트 없음",
    modelUsageOther: "기타 모델",
    emptyTitle: "사용 통계가 아직 없습니다",
    emptyDesc: "이 범위에는 완료된 대화가 아직 없습니다. 통계는 사용하면서 쌓입니다.",
    emptyAction: "앱으로 돌아가기",
    nudgeText: "두 기능 모두 로컬에서 실행되며 워크스페이스 내용을 업로드하지 않습니다.",
    nudgeDismiss: "확인",
    lastUpdated: "마지막 업데이트: {{time}}",
    provenanceFields: "토큰, 대화 시간, 모델, 프로젝트를 포함합니다.",
    loadingPrivacy: "데이터는 서버로 업로드되지 않습니다.",
    "projectFilter": "프로젝트",
    "allProjects": "모든 프로젝트",
  },
