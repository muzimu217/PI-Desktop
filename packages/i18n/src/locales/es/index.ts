...
"importConfirm": "Las extensiones importadas se ejecutan en el proceso del agente con el mismo acceso que sus propias herramientas. Las habilidades declaradas pueden añadir instrucciones al agente y las dependencias declaradas se instalan con npm (scripts de instalación desactivados). ¿Continuar?",
  ...
  "stats": {
    ...
    "loadErrorHost": "No se puede conectar con el servicio local. Tu historial sigue a salvo: vuelve a intentarlo.",
    "range": "Rango",
    ...
    "inclSubagents": "Incluye subagentes",
    "peakDay": "Día pico",
    "longestChat": "Chat más largo",
    "pureChat": "Tiempo puro de chat",
    "currentStreak": "Racha actual",
    "longestStreak_one": "Más larga: 1 día",
    "longestStreak_other": "Más larga: {{count}} días",
    "days_one": "1 día",
    "days_other": "{{count}} días",
    "activity": "Actividad",
    "heatmapAria": "Actividad de tokens de los últimos {{days}} días: {{tokens}} en total, pico de {{peakTokens}} el {{peakDate}}",
    "heatmapTableCaption": "Actividad diaria de tokens de los últimos 365 días",
    "trendAria": "Tendencia diaria de tokens durante {{days}} días: {{tokens}} en total, pico de {{peakTokens}} el {{peakDate}}",
    "trendTableCaption": "Totales diarios de tokens y desglose por modelo",
    "tableDate": "Fecha",
    "tableTokens": "Tokens",
    "modelUsage": "Uso por modelo",
    "insights": "Diagnóstico",
    "cacheLeverage": "Aprovechamiento de caché",
    "largeContext": "Turnos de contexto grande",
    "top5Share": "Concentración top 5",
    ...
    "openSession": "Abrir la sesión {{title}}",
    ...
    "projectUsage": "Desglose por proyecto",
    "projectUsageOther": "Otros",
    "noProject": "Sin proyecto",
    "modelUsageOther": "Otros modelos",
    "emptyTitle": "Aún no hay datos de uso",
    "emptyDesc": "Aún no hay conversaciones completadas en este rango. Las estadísticas crecen con el uso.",
    "emptyAction": "Volver a la app",
    ...
    "provenanceFields": "Incluye tokens, duración del chat, modelos y proyectos.",
    "loadingPrivacy": "Los datos nunca se suben a un servidor.",
