...
importConfirm: "İçe aktarılan uzantılar ajan sürecinde, ajanın kendi araçlarıyla aynı erişimle çalışır. Bildirilen beceriler ajana talimatlar ekleyebilir ve bildirilen bağımlılıklar npm ile yüklenir (yükleme betikleri devre dışı). Devam edilsin mi?",
  ...
  index: {
    ...
    "grepBoostDesc": "Yeni açılan çalışma alanlarını arka planda otomatik dizinler ve koşula uyan hazır değer aramalarını bu dizinden sunar; diğerleri rg'ye geri döner. Her şey bu makinede kalır.",
    ...
    emptyDesc: "Oluşturduğunuzda dosya sayısını ve boyutu görürsünüz. Dizin bu makinede kalır.",
  ...
  stats: {
    ...
    loadErrorHost: "Yerel hizmete ulaşılamıyor. Geçmişiniz güvende — yeniden deneyin.",
    range: "Aralık",
    range7: "Son 7 gün",
    range30: "Son 30 gün",
    refresh: "Yenile",
    ...
    inclSubagents: "Alt ajanlar dahil",
    peakDay: "Zirve gün",
    longestChat: "En uzun sohbet",
    pureChat: "Net sohbet süresi",
    currentStreak: "Mevcut seri",
    longestStreak_one: "En uzun: 1 gün",
    longestStreak_other: "En uzun: {{count}} gün",
    days_one: "1 gün",
    days_other: "{{count}} gün",
    activity: "Etkinlik",
    heatmapAria: "Son {{days}} gün token etkinliği: toplam {{tokens}}, zirve {{peakTokens}} ({{peakDate}})",
    heatmapTableCaption: "Son 365 günün günlük token etkinliği",
    trendAria: "{{days}} günlük token eğilimi: toplam {{tokens}}, zirve {{peakTokens}} ({{peakDate}})",
    trendTableCaption: "Günlük token toplamları ve model bazlı dağılım",
    tableDate: "Tarih",
    tableTokens: "Token",
    modelUsage: "Model kullanımı",
    insights: "Teşhis",
    cacheLeverage: "Önbellek kaldıracı",
    largeContext: "Büyük bağlam turları",
    top5Share: "İlk 5 oturum yoğunluğu",
    ...
    openSession: "{{title}} oturumunu aç",
    empty: "Bu aralıkta henüz oturum yok",
    provenance: "Yerel oturum geçmişinizden hesaplanır. Hiçbir şey bu makineden çıkmaz.",
    projectUsage: "Proje dökümü",
    projectUsageOther: "Diğer",
    noProject: "Proje yok",
    modelUsageOther: "Diğer modeller",
    emptyTitle: "Henüz kullanım verisi yok",
    emptyDesc: "Bu aralıkta henüz tamamlanmış konuşma yok. İstatistikler kullanımla birlikte birikir.",
    emptyAction: "Uygulamaya dön",
    ...
    provenanceFields: "Token, sohbet süresi, modeller ve projeleri kapsar.",
    loadingPrivacy: "Veriler asla sunucuya yüklenmez.",
    "projectFilter": "Proje",
